    ...
    <>
      ...
      <Layout>
        ...
        <div className="flex flex-col w-full h-full space-y-3">
          <span className="text-4xl font-bevan font-semibold">Projects</span>
...
const ProjectItem = ({ image, title, description, tech, links }) => {
  const linkItems = links.map((item, index) => (
    <li key={index}>
      <a
        className="hover:text-primary text-sm text-gray-700 font-semibold"
        href={item.href}
      >
        {item.type}
      </a>
  ...
  return {
    projects: [
      ...
      },
      {
        ...
        The extension has 20,000 users as of November 2020.`,
        ...
        links: [
          {
            type: "website",
            href:
              "https://chrome.google.com/webstore/detail/search-bar-for-classroom/dmlfplbdckbemkkhkojekbagnpldghnc",
          },
          {
            type: "github",
            href: "https://github.com/micahcantor/SearchBarForClassroom",
          },
        ],
      },
      {
        title: "The Game of Life",
        description: `A Typescript implementation of Conway's Game of Life using James Routely's minimalist Javascript
        game engine, 24a2.`,
        image: data.gol.childImageSharp.fluid,
        tech: ["Typescript"],
        links: [
          { type: "website", href: "/game-of-life-24a2" },
          {
            type: "github",
            href:
              "https://github.com/micahcantor/personal-site/blob/master/src/pages/game-of-life-24a2.tsx",
          },
        ],
      },
      {
        ...
        links: [
          {
            type: "website",
            href:
              "https://chrome.google.com/webstore/detail/dailypapers/ipodddjpoagkaecbkadidoiedjkomghp",
          },
          {
            type: "github",
            href: "https://github.com/micahcantor/dailypapers",
          },
        ],
      },
      {
        ...
        links: [
          ...
          {
            type: "github",
            href: "https://github.com/micahcantor/personal-site",
          },
        ],
      },
    ],
...
export const imagesQuery = graphql`
  {
    ...
    gol: file(relativePath: { eq: "gol_24.png" }) {
      childImageSharp {
        fluid(maxWidth: 500, quality: 100) {
          ...GatsbyImageSharpFluid
        }
